 ...
 * @author Adamantium
 */
public class VtnSolicitudReparacion extends javax.swing.JFrame implements Observer {
    ...
    DefaultListModel modeloListaProblema = new DefaultListModel();
    DefaultComboBoxModel modeloComboProblemas = new DefaultComboBoxModel();
    int duracion = 0;

    /**
     * Creates new form VtnSolicitudServicio
     */
    VtnSolicitudReparacion() {
        initComponents();
    }
     ...
     * @param emp 
     */
    VtnSolicitudReparacion(Empresa emp) {
        this();
        this.emp = emp;
    ...
    private void initComponents() {
        ...
        setTitle("Solicitud de Mantenimiento");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(ComboVehiculos, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Problemas"));
        jPanel3.setToolTipText("Problemas");

        ListaProblemas.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jScrollPane1.setViewportView(ListaProblemas);
        ...
        LblTiempoEstimado.setText("00:00");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(ComboProblemas, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jLabel5)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(CalFecha, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void horaString(int tiempo){
        int hora = tiempo / 60;
        int minutos = tiempo - (hora * 60);
        String textoHora = hora + ":" + minutos + " Hs."; 
        LblTiempoEstimado.setText(textoHora);
    }
                ...
                if (ComboVehiculos.getItemCount() > 0) {
                    ...
                    if (!ListaEspecialistas.isSelectionEmpty()) {
                        ...
                        if (!ListaHorario.isSelectionEmpty()) {
                            ...
                            this.emp.confirmarReserva(auxCliente, auxVehiculo, auxEspecialista, diaSeleccionado, listaDeProblemas);
